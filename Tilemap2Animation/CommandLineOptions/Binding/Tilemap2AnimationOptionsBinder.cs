...
/// </summary>
public class Tilemap2AnimationOptionsBinder : BinderBase<Tilemap2AnimationWorkflowOptions>
{
    ...
    /// <summary>
    /// Creates a new instance of <see cref="Tilemap2AnimationWorkflowOptions"/> from command line arguments
    /// </summary>
    /// <param name="bindingContext">The binding context</param>
    /// <returns>A new instance of <see cref="Tilemap2AnimationWorkflowOptions"/></returns>
    protected override Tilemap2AnimationWorkflowOptions GetBoundValue(BindingContext bindingContext)
    {
        return new Tilemap2AnimationWorkflowOptions
        {
